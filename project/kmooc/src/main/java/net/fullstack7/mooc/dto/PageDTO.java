 ...
 * 페이징 할 때 사용할 DTO 클래스
 * 사용법
 * 1. pageNo, pageSize, searchField, searchValue, sortField, sortDirection 을 해당 페이지에서 request parameter 로 받아옴
 * 2. initialize() 메서드를 실행해서 초기값을 입력함
 * 3. setTotalCount(int totalCount) 메서드로 Service 에서 받은 totalCount 를 입력함
